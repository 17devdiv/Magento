...
return [
    'modules' => [
        ...
        'DS_Despatchtimer' => 0,
        'Dotsquares_Defaultset' => 1,
        'Dotsquares_Enquiry' => 1,
        'Dotsquares_Gdpr' => 1,
        'Dotsquares_Instagramslider' => 1,
        'Dotsquares_Marketplace' => 0,
        'Dotsquares_Offerbanner' => 1,
        'Dotsquares_Productfaq' => 1,
        'Dotsquares_Quickcontact' => 1,
        'Dotsquares_Sitemap' => 1,
        'Dotsquares_Sortbyoutofstock' => 1,
        'Dotsquares_SubscriberRebate' => 1,
        'Ds_Featuredproducts' => 1,
        'PayPal_Braintree' => 1,
