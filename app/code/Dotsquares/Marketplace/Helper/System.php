...
class System extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        ...
        $isSellerSubscriptionEnabled = $objectManager->get ( 'Dotsquares\Marketplace\Helper\Data' )->isSellerSubscriptionEnabled ();
        if ($isSellerSubscriptionEnabled == 1) {
            $date = $objectManager->get ( 'Magento\Framework\Stdlib\DateTime\DateTime' )->gmtDate ();
            $sellerSubscribedPlan = $objectManager->get ( 'Dotsquares\Marketplace\Model\Subscriptionprofiles' )->getCollection ();
            ...
            if (count ( $sellerSubscribedPlan )) {
                ...
                $productDataTotalCount = $objectManager->get ( 'Dotsquares\Marketplace\Model\Bulkupload' )->getProductTotalCount ( $productData );
