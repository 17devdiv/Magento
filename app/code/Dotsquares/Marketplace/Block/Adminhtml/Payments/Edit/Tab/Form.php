 ...
 *
 * */
namespace Dotsquares\Marketplace\Block\Adminhtml\Payments\Edit\Tab;
...
class Form extends Generic implements TabInterface {
     ...
     * @return void
     */
    public function __construct(Context $context, Registry $registry, FormFactory $formFactory, Config $wysiwygConfig, Status $newsStatus, \Dotsquares\Marketplace\Model\Config\Source\Status $status, array $data = []) {
