 ...
 *
 * */
namespace Dotsquares\Marketplace\Block\Adminhtml\Review\Edit\Tab;
...
class Info extends Generic implements TabInterface {
     ...
     * @return object        
     */
    public function __construct(Context $context, Registry $registry, FormFactory $formFactory, Config $wysiwygConfig, Status $newsStatus, \Dotsquares\Marketplace\Model\System\Config\Status $status, array $data = []) {
