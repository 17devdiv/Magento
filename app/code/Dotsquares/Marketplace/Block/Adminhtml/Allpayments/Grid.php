 ...
 *
 */
namespace Dotsquares\Marketplace\Block\Adminhtml\Allpayments;
/**
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended {
    ...
    * @param \Dotsquares\Marketplace\Model\System\Config\Status $status
    * @param \Magento\Framework\Module\Manager $moduleObj
    * @param array $data
    * @return void
    */
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Backend\Helper\Data $backendHelper, \Dotsquares\Marketplace\Model\System\Config\Status $status, \Magento\Framework\Module\Manager $moduleObj, array $data = []) {
        $this->status = $status;
    ...
    protected function _prepareColumns() {
        ...
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        $options = $objectManager->get ( 'Dotsquares\Marketplace\Model\Config\Source\Isack' )->toOptionArray ();
