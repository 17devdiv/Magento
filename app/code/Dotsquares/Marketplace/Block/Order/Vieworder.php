 ...
 *
 */
namespace Dotsquares\Marketplace\Block\Order;
...
class Vieworder extends \Magento\Framework\View\Element\Template {
    ...
    /**
     *
     * @var \Dotsquares\Marketkplace\Helper\System
     */
     ...
     * @param array $data            
     */
    public function __construct(\Dotsquares\Marketplace\Helper\System $systemHelper, TemplateContext $context, Registry $registry, AddressRenderer $addressRenderer, \Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Framework\Locale\CurrencyInterface $localeCurrency, array $data = []) {
    ...
    public function getOrderDetails($orderId) {
         ...
         * Get product details
         */
        $products = $objectManager->get ( 'Dotsquares\Marketplace\Model\Orderitems' )->getCollection ();
        ...
        $sellerOrderCollection = $objectManager->get ( 'Dotsquares\Marketplace\Model\Order' )->getCollection ()->addFieldToFilter ( 'order_id', $orderId )->addFieldToFilter ( 'seller_id', $sellerId )->getFirstItem ();
         ...
         */
        if (isset ( $sellerOrderCollection )) {
    ...
    public function getOrderPriceDetails($orderId) {
         ...
         */
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        $productss = $objectManager->get ( 'Dotsquares\Marketplace\Model\Order' )->getCollection ();
