...
class Review extends \Magento\Framework\View\Element\Template {
    ...
    public function getStoreDetails() {
        ...
        $sellerId = $this->getSellerId ();
        return $objectManager->get ( 'Dotsquares\Marketplace\Model\Seller' )->load ( $sellerId, 'customer_id' );
    }
    ...
    public function getSellerReview() {
        $sellerId = $this->getSellerId ();
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        $reviews = $objectManager->get ( 'Dotsquares\Marketplace\Model\Review' )->getCollection ();
    ...
    public function canReview($customerId, $sellerId) {
        ...
        if ($purchaseSellerOrderCount >= 1) {
            ...
            $sellerReviewCollection = $objectManager->get ( 'Dotsquares\Marketplace\Model\Review' )->getCollection ();
