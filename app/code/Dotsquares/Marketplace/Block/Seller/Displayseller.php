...
class Displayseller extends \Magento\Directory\Block\Data {
    ...
    public function canReview($customerId, $sellerId) {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        return $objectManager->get ( 'Dotsquares\Marketplace\Block\Seller\Review' )->canReview ( $customerId, $sellerId );
    }
    /**
    ...
    public function isSellerReviewEnabled() {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        $sellerReview = $objectManager->get ( 'Dotsquares\Marketplace\Helper\Data' );
