...
class Manage extends \Magento\Framework\View\Element\Template {
     ...
     * @param array $data            
     */
    public function __construct(Template\Context $context, Collection $assignproductFactory, StockRegistry $stockRegistry, \Dotsquares\Marketplace\Helper\System $systemHelper, \Magento\Framework\Message\ManagerInterface $messageManager, array $data = []) {
