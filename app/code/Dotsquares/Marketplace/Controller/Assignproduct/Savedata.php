        ...
        if ($baseTypeId == "configurable") {
            ...
            foreach ( $variants as $variant ) {
                ...
                if (! in_array ( $variant, $childrenProductIds )) {
                     ...
                     */
                    $baseSimpleIds [] = $this->_objectManager->get ( 'Dotsquares\Marketplace\Controller\Assignproduct\Save' )->saveAssignproduct ( $childArray, $sellerId, $productData, $attributeValues, $baseConfigproduct, $parentId );
                }
