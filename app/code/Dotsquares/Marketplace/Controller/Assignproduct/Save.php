...
class Save extends \Magento\Framework\App\Action\Action {
    ...
    public function saveAssignproduct($childArray, $sellerId, $productData, $attributeValues, $assignProductData, $parentId) {
         ...
         */
        $this->_objectManager->get ( 'Dotsquares\Marketplace\Controller\Product\Savedata' )->baseImageForProduct ( $assignProduct->getId (), $productData->getImage () );
        $this->_objectManager->get ( 'Dotsquares\Marketplace\Controller\Product\Savedata' )->updateStockDataForProduct ( $assignProduct->getId (), $assignproductStockData );
    ...
    public function saveConfigurableProductInfo($assignProductData, $configProductData, $sellerId, $simpleIds, $configAttributes,$nationalShippingAmount,$internationalShippingAmount) {
         ...
         * Save stock and image for product
         */
        $this->_objectManager->get ( 'Dotsquares\Marketplace\Controller\Product\Savedata' )->baseImageForProduct ( $configProduct->getId (), $configProductData->getImage () );
        ...
        if ($typeId != "configurable") {
            $this->_objectManager->get ( 'Dotsquares\Marketplace\Controller\Product\Savedata' )->updateStockDataForProduct ( $configProduct->getId (), $assignProductData );
        }
        if ($typeId == "configurable") {
