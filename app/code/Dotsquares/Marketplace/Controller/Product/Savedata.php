...
class Savedata extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        $postValue = $this->request->getPost()->toArray();
        ...
        $marketplaceGeneral = $this->_objectManager->get ( 'Dotsquares\Marketplace\Helper\General' );
    ...
    public function setProductData($product, $categoryIds, $productData, $nationalShippingAmount, $internationalShippingAmount, $customAttributes) {
        ...
        if (! empty ( $customAttributes )) {
            $product = $this->_objectManager->get ( 'Dotsquares\Marketplace\Block\Product\Configurable' )->addCustomAttributes ( $product, $customAttributes, $productData );
        }
            ...
            foreach ( $configurableProducts as $configurableProduct ) {
                ...
                if (isset ( $configurableProduct ['attribute_combination'] )) {
                    ...
                    if ($configurableImage == 'image_all' && isset ( $configurableProduct ['image_path'] ['all'] )) {
                        ...
                        $imagesPaths = $simpleProductImagesPath = $this->_objectManager->create ( '\Dotsquares\Marketplace\Model\Seller' )->getImagesForConfigurable($configurableProduct ['image_path'] ['all']);
