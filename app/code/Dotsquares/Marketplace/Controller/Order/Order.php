...
class Order extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        $sellerOrderItems = $this->_objectManager->get ( 'Dotsquares\Marketplace\Model\Orderitems' )->load ( $id, 'order_item_id' );
        ...
        if ($sellerOrderItems->getSellerId () == $sellerId) {
            ...
            if ($action == 'canceled' || $action == 'returned') {
                ...
                $orderItems = $this->_objectManager->get ( 'Dotsquares\Marketplace\Model\Orderitems' )->getCollection ();
                ...
                if ($orderItemCount == $canceledOrderItemCount) {
                    $sellerOrder = $this->_objectManager->get ( 'Dotsquares\Marketplace\Model\Order' )->getCollection ();
                    ...
                    $updateOrderStatus = $this->_objectManager->get ( 'Dotsquares\Marketplace\Model\Order' )->load ( $sellerOrderId );
                    if ($action == 'canceled') {
                ...
                $allSellerOrderItem = $this->_objectManager->get ( 'Dotsquares\Marketplace\Model\Orderitems' )->getCollection ();
