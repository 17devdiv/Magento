...
namespace Dotsquares\SubscriberRebate\Ui\Program;
    ...
    \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    /**
     * @var \Dotsquares\SubscriberRebate\Model\ResourceModel\Program\Collection
     */
    ...
    public function __construct(
        ...
        $primaryFieldName,
        $requestFieldName,
        \Dotsquares\SubscriberRebate\Model\ResourceModel\Program\Collection $collection,
        array $meta = [],
        array $data = []
    ) {
