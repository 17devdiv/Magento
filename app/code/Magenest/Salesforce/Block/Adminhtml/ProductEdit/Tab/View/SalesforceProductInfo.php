...
/**
 * Class SalesforceProductInfo
 * @package Magenest\Salesforce\Block\Adminhtml\ProductEdit\Tab\View
 */
class SalesforceProductInfo extends \Magento\Backend\Block\Template
{
    /** @var string  */
    protected $_template = 'tab/view/salesforce_product_info.phtml';
    ...
    /**
     * @return \Magenest\Salesforce\Model\ResourceModel\Report\Collection
     */
